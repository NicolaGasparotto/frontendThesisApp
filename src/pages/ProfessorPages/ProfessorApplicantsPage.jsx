          ...
          return (
            <MyPaperWrap key={application.proposal_id} elevation={3}>
              <Stack sx={{
                ...
                <Stack direction='column' spacign={5}  sx={{alignItems: 'center'}}>
                    ...
                    return (
                      <Stack key={applicant.id} direction='row' sx={{display: 'flex', justifyContent: 'space-between', flexDirection: {sm: 'row', xs: 'column'},}}>
                        ...
                        <Box sx={{display: 'flex', gap: '10px'}}>
                          <MyOutlinedButton colorBorder={'green'} colorBorderHover={'red'} text={'Accept'} style={{fontSize: 'medium', borderRadius: '18px'}}  />
                          <MyOutlinedButton colorBorder={'red'} colorBorderHover={'green'} text={'Decline'} style={{fontSize: 'medium', borderRadius: '18px'}}  />
                        </Box>
